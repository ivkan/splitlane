...
//! for the Review view. See [`super`] for `DiffView`.
...
impl DiffView {
    ...
    pub(super) fn launch_review(
        ...
        // Configurable prefill delay (default 2000 ms); clipboard write
    ...
    pub(super) fn render_review_terminals(
        ...
        // The review prompt is pre-filled after a fixed delay, but on a
        ...
        let tab_strip = div()
            ...
            .bg(ui.base)
            .child(tabs)
            // Surface the clipboard safety net immediately. Kept in the
