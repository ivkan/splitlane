...
//! underneath - the canonical fix for the block-character seam gaps.
...
pub fn paint_cell_backgrounds(
    ...
    // caller passes empty boundary slices in that case, so guard
    ...
    for rect in &layout.rects {
        ...
        // SPLITLANE_PIXEL_PROBE: capture the post-extension rect coordinates
...
pub fn paint_block_quads(
    ...
    for bq in &layout.block_quads {
        ...
        // SPLITLANE_PIXEL_PROBE: block quads are the canonical "fix this
        // gap" surface for block characters - log the
