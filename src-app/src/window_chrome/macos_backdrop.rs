//! Native macOS material for Splitlane's unified sidebar and title bar.
...
/// title bar. Splitlane's opaque shell mask hides it everywhere except the inset
...
/// Keeps AppKit vibrancy and visibility aligned with Splitlane's live settings.
